...
std::vector<unsigned long> GetRequiredTagForCup() {
...
emv::EmvTerminalApplication GetCupApp() {
  types::TagValues aid_tags(
      {
          ...
          { TAG_EMV_INT_TAC_ONLINE, { 0xFC, 0x78, 0xFC, 0xF8, 0xF0 } },
          { TAG_EMV_INT_TAC_DEFAULT, { 0xFC, 0x78, 0xFC, 0xF8, 0xF0 } },
          { TAG_EMV_INT_DEFAULT_DDOL, { 0x9F, 0x37, 0x04 } },
          { TAG_EMV_INT_DEFAULT_TDOL, { 0x95, 0x05, 0x9A, 0x03 } } });

  return emv::EmvTerminalApplication(kCupAid, aid_tags, true,
                                     GetCupTestCapks(),
                                     GetRequiredTagForCup(),
