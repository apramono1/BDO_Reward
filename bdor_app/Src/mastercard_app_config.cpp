...
std::vector<unsigned long> GetRequiredTagForMasterCard() {
  std::vector<unsigned long> tag_list = { 0x82, 0x84, 0x95, 0x9A, 0x9C, 0x5F2A,
      ...
      0x9F35, 0x9F36, 0x9F37, 0x9F41, 0x9F42, 0x9F53, 0x9F5A, 0x9F5B };
...
emv::EmvTerminalApplication GetMasterCardApp()
{
  types::TagValues aid_tags(
        ...
        { TAG_EMV_INT_THRESHOLD_VALUE_BIASED_RAND_SEL, {0x00, 0x00, 0x00, 0x00}},
        ...
        { TAG_EMV_INT_TAC_ONLINE, {0xFC, 0x50, 0xA8, 0xF8, 0x00}}, // FC 50 A8 F8 00
        { TAG_EMV_INT_TAC_DEFAULT, {0xFC, 0x50, 0xA8, 0xA0, 0x00}}, // FC 50 A8 A0 00
    ...
    return emv::EmvTerminalApplication(kMasterCardAid, aid_tags, true, GetMasterCardTestCapks(),
        GetRequiredTagForMasterCard(), emv::EmvTerminalApplication::FORMAT_BERTLV, 8);
  }
