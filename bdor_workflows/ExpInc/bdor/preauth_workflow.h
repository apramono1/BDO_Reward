/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__PREAUTH_WORKFLOW_H_
#define BDOR__PREAUTH_WORKFLOW_H_
...
class PreauthWorkflow : public CardPresenterUser {

 public:
  PreauthWorkflow(ApplicationSettings& app_settings,
               Batch& batch,
               HostSwitch& host,
  ...
  void Start(types::PosConditionCode pos_condition_mode = types::PosConditionCode::PREAUTH);
  Transaction Start(const types::Amount& amount,types::PosConditionCode pos_condition_mode = types::PosConditionCode::PREAUTH);
