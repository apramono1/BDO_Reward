/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__COMPLETION_ONLINE_WORKFLOW_H_
#define BDOR__COMPLETION_ONLINE_WORKFLOW_H_
...
class CompletionOnlineWorkflow : public CardPresenterUser {

 public:
  CompletionOnlineWorkflow(ApplicationSettings& app_setting,
                           Batch& batch,
                     HostSwitch& host,
 ...
 private:
  ...
  TransactionStatus ProcessCompletionSaleOnline(Transaction& tx);
