/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__REFUND_WORKFLOW_H_
#define BDOR__REFUND_WORKFLOW_H_
...
class RefundWorkflow : public CardPresenterUser {

 public:
  RefundWorkflow(ApplicationSettings& app_settings,
                 Batch& batch,
                 HostSwitch& host,
 ...
 private:
  ...
  bool IsRefundPasswordRequired(const types::Amount& amount) const;
  bool VerifyRefundPassword(const TransactionType tx_type) const;
};
