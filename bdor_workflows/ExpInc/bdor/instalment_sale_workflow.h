/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__INSTALMENT_SALE_WORKFLOW_H_
#define BDOR__INSTALMENT_SALE_WORKFLOW_H_
...
class InstalmentSaleWorkflow : public CardPresenterUser {

 public:
  InstalmentSaleWorkflow(ApplicationSettings& app_settings,
               Batch& batch,
               HostSwitch& host,
 ...
 private:
  ...
  stdx::optional<InstalmentDefinition> instalment_definition_config_;
};
