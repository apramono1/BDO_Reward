...
TipAdjustReceipt::TipAdjustReceipt(tpcore::GoalHandle& gl,
...
TipAdjustReceipt::Body::Body(tpcore::GoalHandle& gl, unsigned printer_timeout)
    : GoalReceipt(gl, printer_timeout) {
}

void TipAdjustReceipt::Body::Expand(const Receipt::Map& dict) {
  ...
  SetPrintDataAmountsForTipAdjust(dict, layout, line);
