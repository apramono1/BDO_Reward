...
InstalmentSaleReceipt::InstalmentSaleReceipt(tpcore::GoalHandle& gl,
...
InstalmentSaleReceipt::Body::Body(tpcore::GoalHandle& gl,
                                  unsigned printer_timeout)
    : GoalReceipt(gl, printer_timeout) {
}

void InstalmentSaleReceipt::Body::Expand(const Receipt::Map& dict) {
  ...
  SetPrintDataTotalAmountOnly(dict, layout, line);
  SetPrintDataTenureInformation(dict, layout, line);
