...
RefundReceipt::RefundReceipt(tpcore::GoalHandle& gl,
...
RefundReceipt::Body::Body(tpcore::GoalHandle& gl,
                          unsigned printer_timeout)
    : GoalReceipt(gl, printer_timeout) {
}

void RefundReceipt::Body::Expand(const Receipt::Map& dict) {
  ...
  SetPrintDataAmountsForVoid(dict, TerminalConfiguration::TIP_DISABLED, layout,
                             line);
