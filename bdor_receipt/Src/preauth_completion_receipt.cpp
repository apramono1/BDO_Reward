...
PreauthCompletionReceipt::PreauthCompletionReceipt(tpcore::GoalHandle& gl,
...
PreauthCompletionReceipt::Body::Body(tpcore::GoalHandle& gl,
                                     unsigned printer_timeout)
    : GoalReceipt(gl, printer_timeout) {
}

void PreauthCompletionReceipt::Body::Expand(const Receipt::Map& dict) {
