...
VoidReceipt::VoidReceipt(tpcore::GoalHandle& gl,
...
VoidReceipt::Body::Body(tpcore::GoalHandle& gl,
                        unsigned printer_timeout,
						TerminalConfiguration::TipProcessingMode terminal_tip_mode)
...
void VoidReceipt::Body::Expand(const Receipt::Map& dict) {
	...
	SetPrintDataAmountsForVoid(dict, tip_mode, layout, line);
