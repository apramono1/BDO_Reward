/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__INSTALMENT_SALE_RECEIPT_H_
#define BDOR__INSTALMENT_SALE_RECEIPT_H_
...
class InstalmentSaleReceipt : public receipt::GoalCompositeReceipt {
 ...
 public:
  InstalmentSaleReceipt(tpcore::GoalHandle& gl,
