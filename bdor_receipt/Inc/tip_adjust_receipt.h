/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__TIP_ADJUST_RECEIPT_H_
#define BDOR__TIP_ADJUST_RECEIPT_H_
...
class TipAdjustReceipt : public receipt::GoalCompositeReceipt {
 ...
 public:
  TipAdjustReceipt(tpcore::GoalHandle& gl,
