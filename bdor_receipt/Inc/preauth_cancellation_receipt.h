/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__PREAUTH_CANCELLATION_RECEIPT_H_
#define BDOR__PREAUTH_CANCELLATION_RECEIPT_H_
...
class PreauthCancellationReceipt : public receipt::GoalCompositeReceipt {
 ...
 public:
  PreauthCancellationReceipt(tpcore::GoalHandle& gl,
                             unsigned printer_timeout,
                             CopyType copy,
                             ReprintType reprint,
                             CvmType cvm_type);
