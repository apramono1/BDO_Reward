/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__PREAUTH_COMPLETION_RECEIPT_H_
#define BDOR__PREAUTH_COMPLETION_RECEIPT_H_
...
class PreauthCompletionReceipt : public receipt::GoalCompositeReceipt {
 ...
 public:
  PreauthCompletionReceipt(tpcore::GoalHandle& gl,
                           unsigned printer_timeout,
                           CopyType copy,
                           ReprintType reprint,
                           CvmType cvm_type);
