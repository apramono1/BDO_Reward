/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__TERMINAL_INITIALIZATION_RECEIPT_H_
#define BDOR__TERMINAL_INITIALIZATION_RECEIPT_H_

#include <receipt/goal_composite_receipt.h>

namespace bdor {

class TerminalInitializationReceipt : public receipt::GoalCompositeReceipt {
 ...
 public:
  TerminalInitializationReceipt(tpcore::GoalHandle& gl,
