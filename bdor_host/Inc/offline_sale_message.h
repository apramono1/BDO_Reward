/*
 ...
 ------------------------------------------------------------------------------
 */
#ifndef BDOR__OFFLINE_SALE_MESSAGE_H_
#define BDOR__OFFLINE_SALE_MESSAGE_H_
...
bool ReadAndValidateOfflineResponseWithDccEnquiry(const iso8583::Apdu& request_apdu,
                      const std::vector<uint8_t>& data,
                      Transaction& tx);

iso8583::Apdu BuildOfflineRequestWithDccAllowed(const Transaction& tx);

bool ReadAndValidateOfflineResponseWithDccAllowed(const iso8583::Apdu& request_apdu,
                      const std::vector<uint8_t>& data,
                      Transaction& tx);
}
